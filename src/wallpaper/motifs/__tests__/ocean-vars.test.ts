...
const REQUIRED_TOKENS = [
  ...
  "moonSurface", "moonGlow", "moonCorona",
  "seaDeep", "seaMid", "moonReflection", "waveEdge",
  "waveColor", "foamColor",
...
function makeColors(): WallpaperColors {
  return {
    bg: "#020814", bgSoft: "#0a1a3a", bgMid: "#061228",
    accent: "#0066ff", accentSoft: "#4499ff", accentMuted: "#001133",
    hueRed: "#ff2244", hueOrange: "#ff8822", hueYellow: "#ffee44",
    hueGreen: "#00cc88", hueCyan: "#00ddff", hueBlue: "#0055ee",
    huePurple: "#8855cc",
    strings: "#00cc88", keywords: "#0066ff", functions: "#00ddff",
    types: "#44aaff", variables: "#aaccdd",
  };
}
